...
enum ZillaSchemaV4: VersionedSchema {
...
enum ZillaMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [ZillaSchemaV1.self, ZillaSchemaV2.self, ZillaSchemaV3.self, ZillaSchemaV4.self]
    }
    ...
    static var stages: [MigrationStage] {
        [
            ...
            .lightweight(fromVersion: ZillaSchemaV3.self, toVersion: ZillaSchemaV4.self)
        ]
    }
}
